...
namespace Org.OpenAPITools.Test
{
    ...
    public class FileApiTests
    {
        ...
        {
            // TODO uncomment below to test 'IsInstanceOf' FileApi
            //Assert.IsInstanceOf(typeof(FileApi), instance);
        }
        ...
        public void UploadFileTest()
        {
            ...
            //var response = instance.UploadFile();
            //Assert.IsInstanceOf(typeof(GetFileResponse), response, "response is GetFileResponse");
        }
