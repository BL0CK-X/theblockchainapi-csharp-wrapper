...
namespace Org.OpenAPITools.Test
{
    ...
    public class SolanaNFTApiTests
    {
        ...
        /// <summary>
        /// Test SolanaGetNFTOwnerAdvanced
        /// </summary>
        [Test]
        public void SolanaGetNFTOwnerAdvancedTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string network = null;
            //string mintAddress = null;
            //var response = instance.SolanaGetNFTOwnerAdvanced(network, mintAddress);
            //Assert.IsInstanceOf(typeof(NFTOwnerAdvancedResponse), response, "response is NFTOwnerAdvancedResponse");
        }
