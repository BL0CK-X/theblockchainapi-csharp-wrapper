...
namespace Org.OpenAPITools.Api
{
    ...
    public interface ISolanaWalletApi : IApiAccessor
    {
        ...
        /// <returns>TransferResponse</returns>
        TransferResponse SolanaTransfer (TransferRequest transferRequest = default(TransferRequest));
        ...
        /// <param name="transferRequest"> (optional)</param>
        /// <returns>ApiResponse of TransferResponse</returns>
        ApiResponse<TransferResponse> SolanaTransferWithHttpInfo (TransferRequest transferRequest = default(TransferRequest));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TransferResponse</returns>
        System.Threading.Tasks.Task<TransferResponse> SolanaTransferAsync (TransferRequest transferRequest = default(TransferRequest), CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TransferResponse)</returns>
        System.Threading.Tasks.Task<ApiResponse<TransferResponse>> SolanaTransferWithHttpInfoAsync (TransferRequest transferRequest = default(TransferRequest), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class SolanaWalletApi : ISolanaWalletApi
    {
        ...
        /// <summary>
        /// Get address&#39;s NFTs &lt;a href&#x3D;\&quot;https://github.com/BL0CK-X/the-blockchain-api/tree/main/examples/solana-wallet/get-wallet-nfts\&quot; target&#x3D;\&quot;_blank\&quot;&gt;See examples (Python, JavaScript)&lt;/a&gt;.      See the NFTs that belong to a given public key address  &#x60;Cost: 1 Credit&#x60; (&lt;a href&#x3D;\&quot;#section/Pricing\&quot;&gt;See Pricing&lt;/a&gt;)
        /// </summary>
        /// <exception cref="Org.OpenAPITools.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="network">The network ID (devnet, mainnet-beta)</param>
        /// <param name="publicKey">The public key of the account whose list of owned NFTs you want to get</param>
        ...
        /// <param name="transferRequest"> (optional)</param>
        /// <returns>TransferResponse</returns>
        public TransferResponse SolanaTransfer (TransferRequest transferRequest = default(TransferRequest))
        {
             ApiResponse<TransferResponse> localVarResponse = SolanaTransferWithHttpInfo(transferRequest);
             return localVarResponse.Data;
        }
        ...
        /// <param name="transferRequest"> (optional)</param>
        /// <returns>ApiResponse of TransferResponse</returns>
        public ApiResponse<TransferResponse> SolanaTransferWithHttpInfo (TransferRequest transferRequest = default(TransferRequest))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TransferResponse</returns>
        public async System.Threading.Tasks.Task<TransferResponse> SolanaTransferAsync (TransferRequest transferRequest = default(TransferRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<TransferResponse> localVarResponse = await SolanaTransferWithHttpInfoAsync(transferRequest, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TransferResponse)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TransferResponse>> SolanaTransferWithHttpInfoAsync (TransferRequest transferRequest = default(TransferRequest), CancellationToken cancellationToken = default(CancellationToken))
        {
