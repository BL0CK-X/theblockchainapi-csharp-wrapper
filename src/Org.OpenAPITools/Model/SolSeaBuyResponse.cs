...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SolSeaBuyResponse :  IEquatable<SolSeaBuyResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolSeaBuyResponse" /> class.
        /// </summary>
        /// <param name="transactionSignature">The signature of the &#x60;buy&#x60; transaction .</param>
        public SolSeaBuyResponse(string transactionSignature = default(string))
        {
        ...
        /// </summary>
        /// <value>The signature of the &#x60;buy&#x60; transaction </value>
        ...
        {
            return this.Equals(input as SolSeaBuyResponse);
        }

        /// <summary>
        /// Returns true if SolSeaBuyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SolSeaBuyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolSeaBuyResponse input)
        {
            if (input == null)
                return false;
