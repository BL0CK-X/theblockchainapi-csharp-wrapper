...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneralGeneratePrivateKeyResponse :  IEquatable<GeneralGeneratePrivateKeyResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralGeneratePrivateKeyResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GeneralGeneratePrivateKeyResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralGeneratePrivateKeyResponse" /> class.
        /// </summary>
        ...
        public GeneralGeneratePrivateKeyResponse(string hexPrivateKey = default(string), Object privateKey = default(Object), string b58PrivateKey = default(string))
        {
            // to ensure "hexPrivateKey" is required (not null)
            if (hexPrivateKey == null)
            {
                throw new InvalidDataException("hexPrivateKey is a required property for GeneralGeneratePrivateKeyResponse and cannot be null");
            }
            else
            {
            ...
            if (privateKey == null)
            {
                throw new InvalidDataException("privateKey is a required property for GeneralGeneratePrivateKeyResponse and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("b58PrivateKey is a required property for GeneralGeneratePrivateKeyResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GeneralGeneratePrivateKeyResponse);
        }

        /// <summary>
        /// Returns true if GeneralGeneratePrivateKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralGeneratePrivateKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralGeneratePrivateKeyResponse input)
        {
            if (input == null)
                return false;
