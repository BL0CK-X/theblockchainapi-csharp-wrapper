...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SolSeaDelistResponse :  IEquatable<SolSeaDelistResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolSeaDelistResponse" /> class.
        /// </summary>
        /// <param name="transactionSignature">The signature of the &#x60;delist&#x60; transaction .</param>
        public SolSeaDelistResponse(string transactionSignature = default(string))
        {
        ...
        /// </summary>
        /// <value>The signature of the &#x60;delist&#x60; transaction </value>
        ...
        {
            return this.Equals(input as SolSeaDelistResponse);
        }

        /// <summary>
        /// Returns true if SolSeaDelistResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SolSeaDelistResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolSeaDelistResponse input)
        {
            if (input == null)
                return false;
