...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class B58PrivateKey :  IEquatable<B58PrivateKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="B58PrivateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected B58PrivateKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="B58PrivateKey" /> class.
        /// </summary>
        ...
        public B58PrivateKey(string b58PrivateKey = default(string))
        {
            // to ensure "b58PrivateKey" is required (not null)
            if (b58PrivateKey == null)
            {
                throw new InvalidDataException("b58PrivateKey is a required property for B58PrivateKey and cannot be null");
            }
            else
            {
                this._B58PrivateKey = b58PrivateKey;
            }
        ...
        public string _B58PrivateKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _B58PrivateKey: ").Append(_B58PrivateKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as B58PrivateKey);
        }

        /// <summary>
        /// Returns true if B58PrivateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of B58PrivateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(B58PrivateKey input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this._B58PrivateKey == input._B58PrivateKey ||
                    (this._B58PrivateKey != null &&
                    this._B58PrivateKey.Equals(input._B58PrivateKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this._B58PrivateKey != null)
                    hashCode = hashCode * 59 + this._B58PrivateKey.GetHashCode();
                return hashCode;
            }
        }
