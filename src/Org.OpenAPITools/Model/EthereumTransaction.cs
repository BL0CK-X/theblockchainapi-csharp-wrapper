...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EthereumTransaction :  IEquatable<EthereumTransaction>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EthereumTransaction" /> class.
        /// </summary>
        ...
        public EthereumTransaction(Object accessList = default(Object), string blockHash = default(string), string blockNumber = default(string), string chainId = default(string), string from = default(string), string gas = default(string), string gasPrice = default(string), string hash = default(string), string input = default(string), string maxFeePerGas = default(string), string maxPriorityFeePerGas = default(string), string nonce = default(string), string r = default(string), string s = default(string), string to = default(string), string transactionIndex = default(string), string type = default(string), string v = default(string), string value = default(string))
        {
        ...
        {
            return this.Equals(input as EthereumTransaction);
        }

        /// <summary>
        /// Returns true if EthereumTransaction instances are equal
        /// </summary>
        /// <param name="input">Instance of EthereumTransaction to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EthereumTransaction input)
        {
            if (input == null)
                return false;
