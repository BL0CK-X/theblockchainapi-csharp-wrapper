...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneralB58PrivateKey :  IEquatable<GeneralB58PrivateKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralB58PrivateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GeneralB58PrivateKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralB58PrivateKey" /> class.
        /// </summary>
        ...
        public GeneralB58PrivateKey(string b58PrivateKey = default(string))
        {
            // to ensure "b58PrivateKey" is required (not null)
            if (b58PrivateKey == null)
            {
                throw new InvalidDataException("b58PrivateKey is a required property for GeneralB58PrivateKey and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GeneralB58PrivateKey);
        }

        /// <summary>
        /// Returns true if GeneralB58PrivateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralB58PrivateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralB58PrivateKey input)
        {
            if (input == null)
                return false;
