...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneralPrivateKey :  IEquatable<GeneralPrivateKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralPrivateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GeneralPrivateKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralPrivateKey" /> class.
        /// </summary>
        ...
        public GeneralPrivateKey(Object privateKey = default(Object))
        {
            // to ensure "privateKey" is required (not null)
            if (privateKey == null)
            {
                throw new InvalidDataException("privateKey is a required property for GeneralPrivateKey and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GeneralPrivateKey);
        }

        /// <summary>
        /// Returns true if GeneralPrivateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralPrivateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralPrivateKey input)
        {
            if (input == null)
                return false;
