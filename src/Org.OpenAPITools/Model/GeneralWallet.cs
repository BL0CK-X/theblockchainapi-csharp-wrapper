...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GeneralWallet :  IEquatable<GeneralWallet>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralWallet" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GeneralWallet() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GeneralWallet" /> class.
        /// </summary>
        ...
        public GeneralWallet(string secretRecoveryPhrase = default(string), string derivationPath = default(string), string passphrase = "", string hexPrivateKey = default(string), Object privateKey = default(Object), string b58PrivateKey = default(string))
        {
            // to ensure "secretRecoveryPhrase" is required (not null)
            if (secretRecoveryPhrase == null)
            {
                throw new InvalidDataException("secretRecoveryPhrase is a required property for GeneralWallet and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("hexPrivateKey is a required property for GeneralWallet and cannot be null");
            }
            else
            {
            ...
            if (privateKey == null)
            {
                throw new InvalidDataException("privateKey is a required property for GeneralWallet and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("b58PrivateKey is a required property for GeneralWallet and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as GeneralWallet);
        }

        /// <summary>
        /// Returns true if GeneralWallet instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralWallet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralWallet input)
        {
            if (input == null)
                return false;
