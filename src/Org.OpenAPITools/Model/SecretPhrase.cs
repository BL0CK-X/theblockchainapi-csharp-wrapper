...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SecretPhrase :  IEquatable<SecretPhrase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecretPhrase" /> class.
        /// </summary>
        /// <param name="secretRecoveryPhrase">The twelve word phrase that can be used to derive many public key addresses (e.g., bottom army bless castle alter habit dish embody child flame smooth zone).  To derive a public key, you need a secret recovery phrase, a derivation path, and an optional passphrase.   Alternatively, you can derive a public key with a private key..</param>
        public SecretPhrase(string secretRecoveryPhrase = default(string))
        {
        ...
        [DataMember(Name="secret_recovery_phrase", EmitDefaultValue=false)]
        ...
        {
            return this.Equals(input as SecretPhrase);
        }

        /// <summary>
        /// Returns true if SecretPhrase instances are equal
        /// </summary>
        /// <param name="input">Instance of SecretPhrase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecretPhrase input)
        {
            if (input == null)
                return false;
