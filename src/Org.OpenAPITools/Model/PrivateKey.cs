...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PrivateKey :  IEquatable<PrivateKey>, IValidatableObject
    {
        ...
        public PrivateKey(Object privateKey = default(Object))
        {
            // to ensure "privateKey" is required (not null)
            if (privateKey == null)
            {
                throw new InvalidDataException("privateKey is a required property for PrivateKey and cannot be null");
            }
            else
            {
        ...
        public Object _PrivateKey { get; set; }
