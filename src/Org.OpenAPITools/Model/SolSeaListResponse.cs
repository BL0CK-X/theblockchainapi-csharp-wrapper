...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SolSeaListResponse :  IEquatable<SolSeaListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolSeaListResponse" /> class.
        /// </summary>
        /// <param name="transactionSignature">The signature of the &#x60;list&#x60; transaction .</param>
        public SolSeaListResponse(string transactionSignature = default(string))
        {
        ...
        /// </summary>
        /// <value>The signature of the &#x60;list&#x60; transaction </value>
        ...
        {
            return this.Equals(input as SolSeaListResponse);
        }

        /// <summary>
        /// Returns true if SolSeaListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SolSeaListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolSeaListResponse input)
        {
            if (input == null)
                return false;
