...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Wallet :  IEquatable<Wallet>, IValidatableObject
    {
        ...
        public Wallet(string secretRecoveryPhrase = default(string), string derivationPath = "m/44/501/0/0", string passphrase = "", Object privateKey = default(Object), string b58PrivateKey = default(string))
        {
            // to ensure "secretRecoveryPhrase" is required (not null)
            if (secretRecoveryPhrase == null)
            {
                throw new InvalidDataException("secretRecoveryPhrase is a required property for Wallet and cannot be null");
            }
            else
            {
            ...
            if (privateKey == null)
            {
                throw new InvalidDataException("privateKey is a required property for Wallet and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("b58PrivateKey is a required property for Wallet and cannot be null");
            }
            else
            {
