...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProjectCreateRequest :  IEquatable<ProjectCreateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public ProjectCreateRequest(string projectName = default(string), string projectDescription = default(string), string contactEmail = default(string), List<Group> groups = default(List<Group>))
        {
        ...
        {
            return this.Equals(input as ProjectCreateRequest);
        }

        /// <summary>
        /// Returns true if ProjectCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectCreateRequest input)
        {
            if (input == null)
                return false;
