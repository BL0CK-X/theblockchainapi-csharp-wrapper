...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class HexPrivateKey :  IEquatable<HexPrivateKey>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HexPrivateKey" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected HexPrivateKey() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="HexPrivateKey" /> class.
        /// </summary>
        ...
        public HexPrivateKey(string hexPrivateKey = default(string))
        {
            // to ensure "hexPrivateKey" is required (not null)
            if (hexPrivateKey == null)
            {
                throw new InvalidDataException("hexPrivateKey is a required property for HexPrivateKey and cannot be null");
            }
            else
            {
        ...
        public string _HexPrivateKey { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _HexPrivateKey: ").Append(_HexPrivateKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as HexPrivateKey);
        }

        /// <summary>
        /// Returns true if HexPrivateKey instances are equal
        /// </summary>
        /// <param name="input">Instance of HexPrivateKey to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(HexPrivateKey input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this._HexPrivateKey == input._HexPrivateKey ||
                    (this._HexPrivateKey != null &&
                    this._HexPrivateKey.Equals(input._HexPrivateKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this._HexPrivateKey != null)
                    hashCode = hashCode * 59 + this._HexPrivateKey.GetHashCode();
                return hashCode;
            }
        }
