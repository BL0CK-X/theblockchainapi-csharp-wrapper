...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CCProject :  IEquatable<CCProject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CCProject" /> class.
        /// </summary>
        ...
        public CCProject(string projectId = default(string), string name = default(string), string description = default(string), string webhook = default(string), string website = default(string), string discordWebhook = default(string), string logoUrl = default(string), CCProjectCreateRequestCustomerIdToCollect customerIdToCollect = default(CCProjectCreateRequestCustomerIdToCollect), string successUrl = default(string), CCProjectCreateRequestPayoutMethod payoutMethod = default(CCProjectCreateRequestPayoutMethod))
        {
            // to ensure "projectId" is required (not null)
            if (projectId == null)
            {
                throw new InvalidDataException("projectId is a required property for CCProject and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for CCProject and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as CCProject);
        }

        /// <summary>
        /// Returns true if CCProject instances are equal
        /// </summary>
        /// <param name="input">Instance of CCProject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CCProject input)
        {
            if (input == null)
                return false;
