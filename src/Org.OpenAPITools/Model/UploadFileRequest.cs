...
namespace Org.OpenAPITools.Model
{
    ...
    {
        /// <summary>
        /// Defines UploadMethod
        /// </summary>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum UploadMethodEnum
        {
            /// <summary>
            /// Enum IPFS for value: IPFS
            /// </summary>
            [EnumMember(Value = "IPFS")]
            IPFS = 1,

            /// <summary>
            /// Enum Arweave for value: Arweave
            /// </summary>
            [EnumMember(Value = "Arweave")]
            Arweave = 2,

            /// <summary>
            /// Enum Filecoin for value: Filecoin
            /// </summary>
            [EnumMember(Value = "Filecoin")]
            Filecoin = 3
        ...
        /// </summary>
        /// <param name="uploadMethod">uploadMethod (default to UploadMethodEnum.IPFS).</param>
        public UploadFileRequest(UploadMethodEnum? uploadMethod = UploadMethodEnum.IPFS)
        {
            // use default value if no "uploadMethod" provided
            if (uploadMethod == null)
            {
                this.UploadMethod = UploadMethodEnum.IPFS;
            }
            else
            {
