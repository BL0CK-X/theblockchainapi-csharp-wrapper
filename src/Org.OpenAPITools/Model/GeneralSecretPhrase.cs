...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GeneralSecretPhrase :  IEquatable<GeneralSecretPhrase>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as GeneralSecretPhrase);
        }

        /// <summary>
        /// Returns true if GeneralSecretPhrase instances are equal
        /// </summary>
        /// <param name="input">Instance of GeneralSecretPhrase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GeneralSecretPhrase input)
        {
            if (input == null)
                return false;
