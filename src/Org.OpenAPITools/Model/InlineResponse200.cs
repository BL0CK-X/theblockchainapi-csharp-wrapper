...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse200 :  IEquatable<InlineResponse200>, IValidatableObject
    {
        ...
        public InlineResponse200(ExchangeEnum? exchange = default(ExchangeEnum?), string exchangeReadable = default(string), string listingTransactionSignature = default(string), string mintAddress = default(string), decimal price = default(decimal))
        {
