...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetNFTListingResponse :  IEquatable<GetNFTListingResponse>, IValidatableObject
    {
        ...
        /// <param name="seller">The public key of the seller.</param>
        public GetNFTListingResponse(ExchangeEnum? exchange = default(ExchangeEnum?), string exchangeReadable = default(string), string listingTransactionSignature = default(string), string mintAddress = default(string), decimal price = default(decimal), string seller = default(string))
        {
        ...
        /// </summary>
        /// <value>The public key of the seller</value>
