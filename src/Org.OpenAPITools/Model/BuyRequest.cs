...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BuyRequest :  IEquatable<BuyRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public BuyRequest(Wallet wallet = default(Wallet), decimal nftPrice = default(decimal))
        {
            ...
            if (wallet == null)
            {
                throw new InvalidDataException("wallet is a required property for BuyRequest and cannot be null");
            }
            else
            {
                this.Wallet = wallet;
            ...
            if (nftPrice == null)
            {
                throw new InvalidDataException("nftPrice is a required property for BuyRequest and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as BuyRequest);
        }

        /// <summary>
        /// Returns true if BuyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BuyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BuyRequest input)
        {
            if (input == null)
                return false;
