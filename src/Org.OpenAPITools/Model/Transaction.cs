...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Transaction :  IEquatable<Transaction>, IValidatableObject
    {
        ...
        /// <param name="jsonrpc">jsonrpc.</param>
        /// <param name="result">result.</param>
        public Transaction(decimal id = default(decimal), string jsonrpc = default(string), TransactionResult result = default(TransactionResult))
        {
            this.Id = id;
