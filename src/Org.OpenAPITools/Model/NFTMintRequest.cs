...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class NFTMintRequest :  IEquatable<NFTMintRequest>, IValidatableObject
    {
        ...
        public NFTMintRequest(bool waitForConfirmation = true, Wallet wallet = default(Wallet), string name = "", string symbol = "", string description = "", UploadMethodEnum? uploadMethod = UploadMethodEnum.S3, string uri = "", string imageUrl = "", Object uriMetadata = default(Object), bool isMutable = true, bool isMasterEdition = true, decimal sellerFeeBasisPoints = 0M, List<string> creators = default(List<string>), List<int> share = default(List<int>), string mintToPublicKey = "The public key of the wallet provided", NetworkEnum? network = NetworkEnum.Devnet)
        {
        ...
        /// </summary>
        /// <value>Whether to wait for the NFT mint to be confirmed on the blockchain or simply be processed.  Processed means that our node has picked up the transaction request, but not that it was confirmed by the Solana cluster.   Confirmed means that the cluster voted on your transaction and approved it. To be completely sure that the NFT was minted, you can either set &#x60;wait_for_confirmation&#x3D;True&#x60; (call takes 20 seconds with True; about 4 seconds for processed) or you can [get the metadata](/#tag/Solana-NFT/operation/solanaGetNFT) from the mint returned. Once it returns the NFT metadata, then the NFT should have been successfully minted. </value>
