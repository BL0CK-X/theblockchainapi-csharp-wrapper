...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SolSeaBuyRequest :  IEquatable<SolSeaBuyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolSeaBuyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SolSeaBuyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SolSeaBuyRequest" /> class.
        /// </summary>
        ...
        public SolSeaBuyRequest(Wallet wallet = default(Wallet), decimal nftPrice = default(decimal))
        {
            // to ensure "wallet" is required (not null)
            if (wallet == null)
            {
                throw new InvalidDataException("wallet is a required property for SolSeaBuyRequest and cannot be null");
            }
            else
            {
                this.Wallet = wallet;
            ...
            if (nftPrice == null)
            {
                throw new InvalidDataException("nftPrice is a required property for SolSeaBuyRequest and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The number of lamports you are expecting to purchase the NFT for. We check the price of the NFT before  purchasing it to ensure that it matches your expectation. There are 1e9 (1 billion) Lamports in a SOL. </value>
        ...
        {
            return this.Equals(input as SolSeaBuyRequest);
        }

        /// <summary>
        /// Returns true if SolSeaBuyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SolSeaBuyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SolSeaBuyRequest input)
        {
            if (input == null)
                return false;
