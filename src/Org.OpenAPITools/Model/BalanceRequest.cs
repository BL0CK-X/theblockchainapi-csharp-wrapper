...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BalanceRequest :  IEquatable<BalanceRequest>, IValidatableObject
    {
        /// <summary>
        /// If you are retrieving the SOL balance, you can select whether to retrieve this in SOL or Lamport units (1 SOL &#x3D; 1e9 Lamports).
        /// </summary>
        /// <value>If you are retrieving the SOL balance, you can select whether to retrieve this in SOL or Lamport units (1 SOL &#x3D; 1e9 Lamports).</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum UnitEnum
        {
            /// <summary>
            /// Enum Lamport for value: lamport
            /// </summary>
            [EnumMember(Value = "lamport")]
            Lamport = 1,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BalanceRequest" /> class.
        /// </summary>
        ...
        /// Initializes a new instance of the <see cref="BalanceRequest" /> class.
        /// </summary>
        /// <param name="publicKey">The public key address of the wallet (required).</param>
        /// <param name="unit">If you are retrieving the SOL balance, you can select whether to retrieve this in SOL or Lamport units (1 SOL &#x3D; 1e9 Lamports). (default to UnitEnum.Lamport).</param>
        /// <param name="network">network (default to NetworkEnum.Devnet).</param>
        /// <param name="mintAddress">The mint address of the SPL token or NFT. If not provided, the balance returned is in SOL. Make sure to use the correct network.  You can see the mint addresses of popular SPL tokens &lt;a href&#x3D;\&quot;https://raw.githubusercontent.com/solana-labs/token-list/main/src/tokens/solana.tokenlist.json\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt;.  Some example mint addresses of SPL tokens: - USDC: EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v - Mango: MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac - Serum: SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt - Raydium: 4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R - wSOL: So11111111111111111111111111111111111111112 - ATLAS: ATLASXmbPQxBUYbxPsV97usA3fPQYEqzQBUHgiFCUsXx (default to &quot;null&quot;).</param>
        public BalanceRequest(string publicKey = default(string), UnitEnum? unit = UnitEnum.Lamport, NetworkEnum? network = NetworkEnum.Devnet, string mintAddress = "null")
        {
            // to ensure "publicKey" is required (not null)
            if (publicKey == null)
            {
                throw new InvalidDataException("publicKey is a required property for BalanceRequest and cannot be null");
            }
            else
            {
            ...
            // use default value if no "mintAddress" provided
            if (mintAddress == null)
            {
        ...
        /// </summary>
        /// <value>The public key address of the wallet</value>
        ...
        /// </summary>
        /// <value>The mint address of the SPL token or NFT. If not provided, the balance returned is in SOL. Make sure to use the correct network.  You can see the mint addresses of popular SPL tokens &lt;a href&#x3D;\&quot;https://raw.githubusercontent.com/solana-labs/token-list/main/src/tokens/solana.tokenlist.json\&quot; target&#x3D;\&quot;_blank\&quot;&gt;here&lt;/a&gt;.  Some example mint addresses of SPL tokens: - USDC: EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v - Mango: MangoCzJ36AjZyKwVj3VnYU4GTonjfVEnJmvvWaxLac - Serum: SRMuApVNdxXokk5GT7XD5cUUgXMBCoAz2LHeuAoKWRt - Raydium: 4k3Dyjzvzp8eMZWUXbBCjEvwSkkk59S5iCNLY3QrkX6R - wSOL: So11111111111111111111111111111111111111112 - ATLAS: ATLASXmbPQxBUYbxPsV97usA3fPQYEqzQBUHgiFCUsXx</value>
        ...
        {
            return this.Equals(input as BalanceRequest);
        }

        /// <summary>
        /// Returns true if BalanceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of BalanceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BalanceRequest input)
        {
            if (input == null)
                return false;
