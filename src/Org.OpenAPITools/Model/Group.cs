...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Group :  IEquatable<Group>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="sectionName">The name of the section under which this group is listed. A section contains several groups. .</param>
        /// <param name="groupName">The name of the group .</param>
        /// <param name="groupDescription">The description of the group .</param>
        public Group(string sectionName = default(string), string groupName = default(string), string groupDescription = default(string))
        {
        ...
        /// </summary>
        /// <value>The name of the section under which this group is listed. A section contains several groups. </value>
        [DataMember(Name="section_name", EmitDefaultValue=false)]
