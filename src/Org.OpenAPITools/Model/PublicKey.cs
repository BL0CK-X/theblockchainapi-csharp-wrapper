...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PublicKey :  IEquatable<PublicKey>, IValidatableObject
    {
        ...
        public PublicKey(string publicKey = default(string))
        {
            // to ensure "publicKey" is required (not null)
            if (publicKey == null)
            {
                throw new InvalidDataException("publicKey is a required property for PublicKey and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _PublicKey: ").Append(_PublicKey).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public bool Equals(PublicKey input)
        {
            ...
            return 
                (
                    this._PublicKey == input._PublicKey ||
                    (this._PublicKey != null &&
                    this._PublicKey.Equals(input._PublicKey))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this._PublicKey != null)
                    hashCode = hashCode * 59 + this._PublicKey.GetHashCode();
                return hashCode;
            }
        }
