...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GetFileResponse :  IEquatable<GetFileResponse>, IValidatableObject
    {
        ...
        /// <param name="size">File size in kilobytes.</param>
        /// <param name="uploadTime">The time when the file was uploaded.</param>
        public GetFileResponse(string uri = default(string), string size = default(string), string uploadTime = default(string))
        {
            this.Uri = uri;
            this.Size = size;
        ...
        /// </summary>
        /// <value>File size in kilobytes</value>
        ...
        /// </summary>
        /// <value>The time when the file was uploaded</value>
