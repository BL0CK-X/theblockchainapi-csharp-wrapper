...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineObject :  IEquatable<InlineObject>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The platform for which the binary was compiled. Note that Darwin &#x3D; Mac.</value>
        ...
        /// </summary>
        /// <param name="platform">The platform for which the binary was compiled. Note that Darwin &#x3D; Mac..</param>
        public InlineObject(PlatformEnum? platform = default(PlatformEnum?))
        {
