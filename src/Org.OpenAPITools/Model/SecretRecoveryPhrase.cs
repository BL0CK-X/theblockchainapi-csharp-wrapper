...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SecretRecoveryPhrase :  IEquatable<SecretRecoveryPhrase>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SecretRecoveryPhrase" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SecretRecoveryPhrase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SecretRecoveryPhrase" /> class.
        /// </summary>
        ...
        public SecretRecoveryPhrase(string secretRecoveryPhrase = default(string), string derivationPath = "m/44/501/0/0", string passphrase = "")
        {
            // to ensure "secretRecoveryPhrase" is required (not null)
            if (secretRecoveryPhrase == null)
            {
                throw new InvalidDataException("secretRecoveryPhrase is a required property for SecretRecoveryPhrase and cannot be null");
            }
            else
            {
                this._SecretRecoveryPhrase = secretRecoveryPhrase;
            }
        ...
        public string _SecretRecoveryPhrase { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  _SecretRecoveryPhrase: ").Append(_SecretRecoveryPhrase).Append("\n");
        ...
        {
            return this.Equals(input as SecretRecoveryPhrase);
        }

        /// <summary>
        /// Returns true if SecretRecoveryPhrase instances are equal
        /// </summary>
        /// <param name="input">Instance of SecretRecoveryPhrase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SecretRecoveryPhrase input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this._SecretRecoveryPhrase == input._SecretRecoveryPhrase ||
                    (this._SecretRecoveryPhrase != null &&
                    this._SecretRecoveryPhrase.Equals(input._SecretRecoveryPhrase))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this._SecretRecoveryPhrase != null)
                    hashCode = hashCode * 59 + this._SecretRecoveryPhrase.GetHashCode();
