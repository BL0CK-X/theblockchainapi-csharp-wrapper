...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EndpointReference :  IEquatable<EndpointReference>, IValidatableObject
    {
        /// <summary>
        ...
        public EndpointReference(string projectId = default(string), string version = default(string), string path = default(string))
        {
            // to ensure "projectId" is required (not null)
            if (projectId == null)
            {
                throw new InvalidDataException("projectId is a required property for EndpointReference and cannot be null");
            }
            else
            {
            ...
            if (version == null)
            {
                throw new InvalidDataException("version is a required property for EndpointReference and cannot be null");
            }
            else
            {
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for EndpointReference and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            return this.Equals(input as EndpointReference);
        }

        /// <summary>
        /// Returns true if EndpointReference instances are equal
        /// </summary>
        /// <param name="input">Instance of EndpointReference to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EndpointReference input)
        {
            if (input == null)
                return false;
