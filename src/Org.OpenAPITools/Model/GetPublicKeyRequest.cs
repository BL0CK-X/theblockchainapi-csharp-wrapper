...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetPublicKeyRequest :  IEquatable<GetPublicKeyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPublicKeyRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPublicKeyRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPublicKeyRequest" /> class.
        /// </summary>
        /// <param name="wallet">wallet (required).</param>
        public GetPublicKeyRequest(Wallet wallet = default(Wallet))
        {
            // to ensure "wallet" is required (not null)
            if (wallet == null)
            {
                throw new InvalidDataException("wallet is a required property for GetPublicKeyRequest and cannot be null");
            }
            else
            {
                this.Wallet = wallet;
        ...
        {
            return this.Equals(input as GetPublicKeyRequest);
        }

        /// <summary>
        /// Returns true if GetPublicKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPublicKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPublicKeyRequest input)
        {
            if (input == null)
                return false;
