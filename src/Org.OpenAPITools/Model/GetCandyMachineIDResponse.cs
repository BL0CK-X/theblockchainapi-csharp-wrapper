...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GetCandyMachineIDResponse :  IEquatable<GetCandyMachineIDResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCandyMachineIDResponse" /> class.
        /// </summary>
        /// <param name="candyMachineId">The ID of the candy machine that minted the NFT.</param>
        ...
        public GetCandyMachineIDResponse(string candyMachineId = default(string), CandyMachineContractVersionEnum? candyMachineContractVersion = default(CandyMachineContractVersionEnum?))
        {
        ...
        /// </summary>
        /// <value>The ID of the candy machine that minted the NFT</value>
        ...
        {
            return this.Equals(input as GetCandyMachineIDResponse);
        }

        /// <summary>
        /// Returns true if GetCandyMachineIDResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of GetCandyMachineIDResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetCandyMachineIDResponse input)
        {
            if (input == null)
                return false;
